...
Then I verify rest response data for weatherapp
  ...
  Scenario: post test
    ...
    Given I verify deleteService for "deleteapp" has status 200 on "putdelete.url" with header params "", path params "deletePath", query params "", form params "",auth "", body "deleteBody"
