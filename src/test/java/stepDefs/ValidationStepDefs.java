...
public class ValidationStepDefs {
    ...
    /**
     * Step validates a given element's attribute/text with cache key
    ...
    public void i_store_given_value(String elementNm, String attr, String key) throws Exception{
        String actValue;
